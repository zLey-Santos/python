...
cores = {
    'limpa': '\033[m',
    'sal': '\033[1:31m',  # Vermelho brilhante para destacar o valor do salário
...
if salario > 5000:
    ...
    print(f'O seu salário passa a ser de '
          f'{cores["R$"]}R${cores["sal"]}{reajuste_10:.2f}{cores["limpa"]},'
          f' 10% de reajuste!')
else:
    ...
    print(f'O seu salário passa a ser de '
          f'{cores["R$"]}R${cores["sal"]}{reajuste_15:.2f}{cores["limpa"]},'
          f' 15% de reajuste')
